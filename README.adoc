...
To start working on this tutorial, we'll need one of the latest versions of IntelliJ IDEA. You can download the latest free community version https://www.jetbrains.com/idea/download[here].

This project is based on Spring Boot 3.2.2, which requires Kotlin 1.9.22. Make sure version 1.9.22 of the Kotlin plugin is installed.To update the Kotlin plugin, use `Tools | Kotlin | Configure Kotlin Plugin Updates`.

=== Downloading the project

Clone the project with the command line:

[source,bash]
$ git clone https://github.com/iptch/kotlin-hands-on-tutorial-2.git
